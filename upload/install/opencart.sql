...
(3, 'Russian', 'ru-ru', 'ru_RU.UTF-8,ru_RU,russian', 'ru-ru.png', 'ru-ru', 3, 1);
-----------------------------------------------------------
...
(120, 1, 'CMS для інтернет-магазинів NovacartCMS v3.x', '&lt;p&gt;Раді представити Вашій увазі NovacartCMS v3.x на основі OPENCART v3.x&lt;/p&gt;\r\n', 'CMS для інтернет-магазинів ocStore v3.x це безкоштовний функціональний движок для створення якісних магазинів, що продають.', 'cms, opencart, ocstore', 'CMS для інтернет-магазинів NovacartCMS v3.x - Скачати', 'CMS для інтернет-магазинів NovacartCMS v3.x', ''),
